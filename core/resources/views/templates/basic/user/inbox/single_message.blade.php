            ...
            @if (@$message->media_path)
                @if (@$message->message_type == Status::IMAGE_TYPE_MESSAGE)
                    <img class="message-image message-image-preview"
                        ...
                        alt="image" style="max-width: 100%; max-height: 600px; cursor: pointer;">
                @endif
                @if (@$message->message_type == Status::STICKER_TYPE_MESSAGE)
                    <img class="message-sticker"
                        src="{{ asset('assets/media/conversation/' . @$message->media_path) }}"
                        alt="sticker" style="max-width: 100px; max-height: 100px;">
                @endif
