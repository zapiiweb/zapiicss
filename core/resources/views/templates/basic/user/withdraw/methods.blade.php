                                    ...
                                    @foreach ($withdrawMethod as $data)
                                        <label for="{{ titleToKey($data->name) }}"
                                            ...
                                            <input class="payment-item__radio gateway-input"
                                                ...
                                                name="method_code" value="{{ $data->id }}" @checked(old('method_code', $loop->first) == $data->id)
                                    ...
                                    <div class="deposit-info">
                                        ...
                                        <div class="deposit-info__input">
                                            <div class="deposit-info__input-group input-group">
                                                <span class="deposit-info__input-group-text input-group-text px-3">{{ gs('cur_sym') }}</span>
                                                <input type="number" class="form-control form--control amount" name="amount"
