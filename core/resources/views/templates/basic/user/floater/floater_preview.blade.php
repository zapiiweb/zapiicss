        ...
        <div class="floater-nav-bottom">
            <div class="floater-popup-whatsapp">
                <div class="floater-content-whatsapp-top">
                    <div class="floater-header-top-wrapper" style="background-color: #{{ $floater->color_code }}">
                        <p>@lang('Welcome')</p>
                ...
                <div class="floater-body-wrap">
                    ...
                    <div class="floater-content-whatsapp-bottom">
                        ...
                        <button class="floater-send-msPopup" id="send-btn" type="button"
                            data-mobile="{{ $floater->dial_code }}{{ $floater->mobile }}"
                            data-message="{{ $floater->message }}">
                            <i style="color: #{{ $floater->color_code }}"
            ...
            <button type="button" id="whats-openPopup" class="floater-whatsapp-button"
                style="background-color: #{{ $floater->color_code }}">
                <svg fill="#ffffff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-2.45 -2.45 35.57 35.57" xml:space="preserve"
                    stroke="#ffffff" stroke-width="0.122668">
