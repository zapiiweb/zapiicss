...
trait UserNotify
{
    public static function notifyToUser()
    {
        return [
            ...
            'scopeDeletedUser'        => 'Account Deleted Users',
            'planSubscribedUser'      => 'Plan Subscribed User',
            'subscriptionExpiredUser' => 'Plan Expired User',
            'freeUser'                => 'The User Who Has Not Purchase Or Subscribed Any Plan',
        ];
    }
    ...
    {
        return $query->where('is_deleted', Status::YES);
    }
    ...
    public function scopePlanSubscribedUser($query)
    {
        return $query->where('plan_id', '!=', Status::NO);
    }
    ...
    {
        return $query->where('plan_id', '!=', Status::NO)->where('plan_expired_at', "<=", now());
    }
}
